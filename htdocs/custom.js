...
// Ensure the UI panels are always fully opaque (100%)
// This needs to run AFTER OpenWebRX has loaded its own settings.
window.addEventListener('load', function() {
    if (typeof UI !== 'undefined' && typeof UI.setOpacity === 'function') {
        UI.setOpacity(100);
    }
});
